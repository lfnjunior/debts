...
export default function User({ history }) {
  ...
  useEffect(() => {
    async function loadUser() {
      ...
      if (userId && token) {
        ...
        this.snack(
          "Não foi encontrado token ou id do usuário armazenados localmente"
        );
      }
    }
    loadUser();
  ...
  async function handleSubmit(event) {
    ...
    if (username === "") snack("Campo Nome de usuário é obrigatório");
      ...
      let bdt = birthdate
        ? moment(birthdate).format("YYYY-MM-DDTHH:mm:ss.sssZ")
        : null;
      let body = {
        username: username,
        password: password,
        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              Após a exclusão você será redirecionado para fora do sistema,
              <br /> e não será possível recuperar a conta.
